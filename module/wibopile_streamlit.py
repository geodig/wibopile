...
class PileCatalog():
    ...
    def __init__(self):
        self.input_file = 'pile_catalog.xlsx'
...
class PileSoilProfile():
    ...
    def read_lithokey(self) -> dict:
        inputfile = openpyxl.load_workbook("lithokey.xlsx")
        sh = inputfile['Sheet1']
    ...
    def get_soil_profile_chart(self, soil_profile_table):
        ...
        wb = openpyxl.load_workbook(self.input_file, data_only=True)
        wb2 = openpyxl.load_workbook("lithokey.xlsx")
...
class PDF(FPDF):
    def header(self):
        ...
        # Logo
        self.image('wblogo_trans2.png', 10, 8, 33)
        # Arial bold 15
